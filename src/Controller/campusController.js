...
async function deleteImageByAdmin(req,res){
    ...
    async function changeCampusNameByAdmin(req,res){
        try{
        const response =await changeImageNameInService(req.params.eventName,req.params.oldEventName,"Campus");
        return res.status(201).json({
            success:true,
            error:{},
            data:{response},
...
module.exports={postImageByAdmin,deleteImageByAdmin,getImageByAdmin_campus,changeCampusNameByAdmin}
